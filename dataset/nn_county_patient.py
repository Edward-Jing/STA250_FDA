...
# Load CSV files
death_df = pd.read_csv('patients_county.csv')
...
for county in target_counties:
    ...
    plt.plot(range(T1, T_total), death_ts[i, T1:], label='True Patients Count (Last 40%)', linestyle='--')
    ...
    # 添加代码：保存图片到fig文件夹下
    # -------------------------------
    save_path = f"fig/patients/county/nn/patients_county_{county}_nn.png"  # 定义保存路径
